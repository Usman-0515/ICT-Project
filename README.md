...
* Multiple event categories: Gaming Tournament, DJ Night and Tech Workshop
* Attractive and fully responsive UI
* Organized navigation with easy access to all pages
...
📦 **No backend required — purely HTML, CSS, and JavaScript.**
...
* Mission statement and project purpose
...
Currently, this project does **not** use any backend or database.
All content is static and written directly in **HTML, CSS, and JavaScript**.
